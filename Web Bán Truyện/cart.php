	...
	<div id="page-content" class="single-page">
		<div class="container">
			...
			$ok=1;
			 ...
			 if($ok == 2)
			 {
				echo "Có ".count($_SESSION['cart']). " truyện trong giỏ hàng ";
			 }
			else
			{
				echo   "<p>Không có Truyện nào trong giỏ hàng</p>";
				exit;
			}
					...
					<div class="col-md-9">
						<div class="caption">
							...
							<input class="form-inline quantity" style="margin-right: 80px;width:50px" min="1" max ="99" type="number" name ="qty[<?php echo $s["ID"] ?>]" value="<?php echo $_SESSION['cart'][$s["ID"]]?>"> 
						     <div>
								<input type="submit" name="update" style="margin-top:31px"  value="cập nhật Truyện này" class="btn btn-2" />
							</div>
							<hr>
							<input type="submit" name="remove" value="xóa Truyện này" class="btn btn-default pull-right" />	
			...
			<a href="rmcart.php" class="btn btn-2" style="margin-bottom:31px">Xóa hết giỏ hàng</a>
				<div class="col-md-4 col-md-offset-8 ">
					<center><a href="index.php" class="btn btn-1" style="margin-left:-76px">Chọn những truyện khác</a></center>
				</div>
			<div class="row">
