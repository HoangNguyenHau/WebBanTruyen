...
if(isset($_POST['submit']))
{
    ...
    $sl;
        ...
        echo "<script>window.location.href = 'http://localhost/Web%20B%c3%a1n%20Truy%e1%bb%87n/cart.php'; </script>";
...
?>
					...
					<div class="product">
						...
						<div class="col-md-6">
							<div class="caption">
								...
								<input type="hidden" name="action" value="them vao gio hang" />
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
		...
		<p>Chức năng mua ngay giúp bạn mua nhanh mà không cần đăng nhập hoặc đặt hàng với một thông tin khác với thông tin trên tài khoản. Tuy nhiên bạn chỉ có thể mua một loại truyện trong một lần đặt hàng, bạn nên đăng nhập để không phải nhập lại thông tin cũng như mua nhiều loại sách cùng lúc.</p>
          ...
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
					...
					<div class="product-desc">
						<ul class="nav nav-tabs">
							<li class="active"><a href="#description">Thông tin truyện</a></li>
						</ul>
